...
(function(root, factory) {
  ...
  describe('UpdateOfferDTO', function() {
    ...
    it('should have the property commodityCodes (base name: "commodityCodes")', function() {
      // uncomment below and update the code to test the property commodityCodes
      //var instance = new Api.UpdateOfferDTO();
      //expect(instance).to.be();
    });
    ...
    it('should have the property firstVideoAsCover (base name: "firstVideoAsCover")', function() {
      // uncomment below and update the code to test the property firstVideoAsCover
      //var instance = new Api.UpdateOfferDTO();
      //expect(instance).to.be();
    });

    it('should have the property deleteParameters (base name: "deleteParameters")', function() {
      // uncomment below and update the code to test the property deleteParameters
      //var instance = new Api.UpdateOfferDTO();
      //expect(instance).to.be();
    });
