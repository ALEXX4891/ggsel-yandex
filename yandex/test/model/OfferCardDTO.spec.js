...
(function(root, factory) {
  ...
  describe('OfferCardDTO', function() {
    ...
    it('should have the property averageContentRating (base name: "averageContentRating")', function() {
      // uncomment below and update the code to test the property averageContentRating
      //var instance = new Api.OfferCardDTO();
      //expect(instance).to.be();
    });

    it('should have the property contentRatingStatus (base name: "contentRatingStatus")', function() {
      // uncomment below and update the code to test the property contentRatingStatus
      //var instance = new Api.OfferCardDTO();
      //expect(instance).to.be();
    });
