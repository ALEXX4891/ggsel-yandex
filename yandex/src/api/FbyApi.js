...
export default class FbyApi {
    ...
    */
     ...
     * @callback module:api/FbyApi~generateUnitedReturnsReportCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GenerateReportResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ReportFormatType} [format] Формат отчета.
     * @param {module:api/FbyApi~generateUnitedReturnsReportCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GenerateReportResponse}
     */
     ...
     * @callback module:api/FbyApi~getRegionsCodesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FbyApi~getRegionsCodesCallback} callback The callback function, accepting three arguments: error, data, response
