...
class OrderDTO {
     ...
     * @param substatus {module:model/OrderSubstatusType} 
     * @param creationDate {String} 
     * @param currency {module:model/CurrencyType} 
     * @param itemsTotal {Number} Платеж покупателя. 
     * @param deliveryTotal {Number} Стоимость доставки. 
     * @param buyerItemsTotalBeforeDiscount {Number} Стоимость всех товаров в заказе в валюте покупателя без учета стоимости доставки и до применения скидок по:  * акциям; * купонам; * промокодам. 
     * @param paymentType {module:model/OrderPaymentType} 
     * @param paymentMethod {module:model/OrderPaymentMethodType} 
     * @param fake {Boolean} Тип заказа:  * `false` — настоящий заказ покупателя.  * `true` — [тестовый](../../concepts/sandbox.md) заказ Маркета. 
     * @param items {Array.<module:model/OrderItemDTO>} Список товаров в заказе.
     * @param delivery {module:model/OrderDeliveryDTO} 
     * @param buyer {module:model/OrderBuyerDTO} 
     * @param taxSystem {module:model/OrderTaxSystemType} 
     */
    constructor(id, status, substatus, creationDate, currency, itemsTotal, deliveryTotal, buyerItemsTotalBeforeDiscount, paymentType, paymentMethod, fake, items, delivery, buyer, taxSystem) { 
        
        OrderDTO.initialize(this, id, status, substatus, creationDate, currency, itemsTotal, deliveryTotal, buyerItemsTotalBeforeDiscount, paymentType, paymentMethod, fake, items, delivery, buyer, taxSystem);
    }
     ...
     */
    static initialize(obj, id, status, substatus, creationDate, currency, itemsTotal, deliveryTotal, buyerItemsTotalBeforeDiscount, paymentType, paymentMethod, fake, items, delivery, buyer, taxSystem) { 
        obj['id'] = id;
        obj['status'] = status;
        ...
        obj['deliveryTotal'] = deliveryTotal;
        obj['buyerItemsTotalBeforeDiscount'] = buyerItemsTotalBeforeDiscount;
...
OrderDTO.RequiredProperties = ["id", "status", "substatus", "creationDate", "currency", "itemsTotal", "deliveryTotal", "buyerItemsTotalBeforeDiscount", "paymentType", "paymentMethod", "fake", "items", "delivery", "buyer", "taxSystem"];
