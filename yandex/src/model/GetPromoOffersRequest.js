...
import PromoOfferParticipationStatusMultiFilterType from './PromoOfferParticipationStatusMultiFilterType';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('statuses')) {
                obj['statuses'] = ApiClient.convertToType(data['statuses'], [PromoOfferParticipationStatusMultiFilterType]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/PromoOfferParticipationStatusMultiFilterType>} statuses
 */
GetPromoOffersRequest.prototype['statuses'] = undefined;
