...
class GoodsFeedbackCommentDTO {
     ...
     */
    constructor(id, text, author, status, feedbackId) { 
        
        GoodsFeedbackCommentDTO.initialize(this, id, text, author, status, feedbackId);
    }
     ...
     */
    static initialize(obj, id, text, author, status, feedbackId) { 
        obj['id'] = id;
        obj['text'] = text;
        obj['author'] = author;
        obj['status'] = status;
...
GoodsFeedbackCommentDTO.RequiredProperties = ["id", "text", "author", "status", "feedbackId"];
 ...
 */
GoodsFeedbackCommentDTO.prototype['feedbackId'] = undefined;
