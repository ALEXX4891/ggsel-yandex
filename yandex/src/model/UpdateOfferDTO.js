...
import CommodityCodeDTO from './CommodityCodeDTO';
import DeleteOfferParameterType from './DeleteOfferParameterType';
...
class UpdateOfferDTO {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('commodityCodes')) {
                obj['commodityCodes'] = ApiClient.convertToType(data['commodityCodes'], [CommodityCodeDTO]);
            }
            ...
            if (data.hasOwnProperty('deleteParameters')) {
                obj['deleteParameters'] = ApiClient.convertToType(data['deleteParameters'], [DeleteOfferParameterType]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['commodityCodes']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['commodityCodes'])) {
                throw new Error("Expected the field `commodityCodes` to be an array in the JSON data but got " + data['commodityCodes']);
            }
            // validate the optional field `commodityCodes` (array)
            for (const item of data['commodityCodes']) {
                CommodityCodeDTO.validateJSON(item);
            };
        }
        // ensure the json data is an array
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['deleteParameters'])) {
            throw new Error("Expected the field `deleteParameters` to be an array in the JSON data but got " + data['deleteParameters']);
        }
...
/**
 * Товарные коды. 
 * @member {Array.<module:model/CommodityCodeDTO>} commodityCodes
 */
UpdateOfferDTO.prototype['commodityCodes'] = undefined;
 ...
 */
UpdateOfferDTO.prototype['firstVideoAsCover'] = undefined;
 ...
 * @member {Array.<module:model/DeleteOfferParameterType>} deleteParameters
 */
UpdateOfferDTO.prototype['deleteParameters'] = undefined;
 ...
 * @member {Array.<module:model/CommodityCodeDTO>} commodityCodes
 */
BaseOfferDTO.prototype['commodityCodes'] = undefined;
/**
 * Номера документов на товар: сертификата, декларации соответствия и т. п.  Передавать можно только номера документов, сканы которого загружены в кабинете продавца по [инструкции](https://yandex.ru/support/marketplace/assortment/restrictions/certificates.html). 
 * @member {Array.<String>} certificates
 */
