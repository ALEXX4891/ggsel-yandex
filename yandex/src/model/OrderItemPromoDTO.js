...
class OrderItemPromoDTO {
     ...
     * @param subsidy {Number} Вознаграждение партнеру от Маркета за товар, проданный в рамках акции. 
     */
    constructor(type, subsidy) { 
        
        OrderItemPromoDTO.initialize(this, type, subsidy);
    }
     ...
     */
    static initialize(obj, type, subsidy) { 
        obj['type'] = type;
        obj['subsidy'] = subsidy;
    }
...
OrderItemPromoDTO.RequiredProperties = ["type", "subsidy"];
