...
import OfferCardContentStatusType from './OfferCardContentStatusType';
...
class OfferCardDTO {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('averageContentRating')) {
                obj['averageContentRating'] = ApiClient.convertToType(data['averageContentRating'], 'Number');
            }
            if (data.hasOwnProperty('contentRatingStatus')) {
                obj['contentRatingStatus'] = OfferCardContentStatusType.constructFromObject(data['contentRatingStatus']);
            }
 ...
 * @member {Number} averageContentRating
 */
OfferCardDTO.prototype['averageContentRating'] = undefined;

/**
 * @member {module:model/OfferCardContentStatusType} contentRatingStatus
 */
OfferCardDTO.prototype['contentRatingStatus'] = undefined;
