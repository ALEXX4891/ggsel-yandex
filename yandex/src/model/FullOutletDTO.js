...
class FullOutletDTO {
     ...
     * @param id {Number} Идентификатор точки продаж, присвоенный Маркетом.
     */
    constructor(name, type, address, phones, workingSchedule, id) { 
        OutletDTO.initialize(this, name, type, address, phones, workingSchedule);
        FullOutletDTO.initialize(this, name, type, address, phones, workingSchedule, id);
    }
     ...
     */
    static initialize(obj, name, type, address, phones, workingSchedule, id) { 
        obj['name'] = name;
        obj['type'] = type;
        obj['address'] = address;
        obj['phones'] = phones;
...
FullOutletDTO.RequiredProperties = ["name", "type", "address", "phones", "workingSchedule", "id"];
