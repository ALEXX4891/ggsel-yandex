...
class OfferCardRecommendationDTO {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('remainingRatingPoints')) {
                obj['remainingRatingPoints'] = ApiClient.convertToType(data['remainingRatingPoints'], 'Number');
            }
        }
        return obj;
    }
 ...
 * @member {Number} remainingRatingPoints
 */
OfferCardRecommendationDTO.prototype['remainingRatingPoints'] = undefined;
