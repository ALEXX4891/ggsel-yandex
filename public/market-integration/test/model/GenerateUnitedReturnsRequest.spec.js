...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.GenerateUnitedReturnsRequest();
  });
  ...
  describe('GenerateUnitedReturnsRequest', function() {
    it('should create an instance of GenerateUnitedReturnsRequest', function() {
      // uncomment below and update the code to test GenerateUnitedReturnsRequest
      //var instance = new Api.GenerateUnitedReturnsRequest();
      //expect(instance).to.be.a(Api.GenerateUnitedReturnsRequest);
    });
    ...
    it('should have the property returnStatusTypes (base name: "returnStatusTypes")', function() {
      // uncomment below and update the code to test the property returnStatusTypes
      //var instance = new Api.GenerateUnitedReturnsRequest();
      //expect(instance).to.be();
    });
