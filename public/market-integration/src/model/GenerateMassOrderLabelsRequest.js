...
import LabelsSortingType from './LabelsSortingType';
...
class GenerateMassOrderLabelsRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('sortingType')) {
                obj['sortingType'] = LabelsSortingType.constructFromObject(data['sortingType']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/LabelsSortingType} sortingType
 */
GenerateMassOrderLabelsRequest.prototype['sortingType'] = undefined;
