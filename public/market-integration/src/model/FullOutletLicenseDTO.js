...
class FullOutletLicenseDTO {
    ...
    constructor(outletId, licenseType, number, dateOfIssue, dateOfExpiry) { 
        ...
        FullOutletLicenseDTO.initialize(this, outletId, licenseType, number, dateOfIssue, dateOfExpiry);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of FullOutletLicenseDTO.RequiredProperties) {
...
FullOutletLicenseDTO.RequiredProperties = ["outletId", "licenseType", "number", "dateOfIssue", "dateOfExpiry"];
