...
import OfferMediaFilesDTO from './OfferMediaFilesDTO';
...
class GetOfferDTO {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mediaFiles')) {
                obj['mediaFiles'] = OfferMediaFilesDTO.constructFromObject(data['mediaFiles']);
            }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `mediaFiles`
        if (data['mediaFiles']) { // data not null
          OfferMediaFilesDTO.validateJSON(data['mediaFiles']);
        }
 ...
 */
GetOfferDTO.prototype['commodityCodes'] = undefined;
...
/**
 * @member {module:model/OfferMediaFilesDTO} mediaFiles
 */
GetOfferDTO.prototype['mediaFiles'] = undefined;
