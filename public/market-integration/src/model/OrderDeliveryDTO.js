...
class OrderDeliveryDTO {
     ...
     * @param type {module:model/OrderDeliveryType} 
     * @param serviceName {String} Наименование службы доставки.
     * @param deliveryPartnerType {module:model/OrderDeliveryPartnerType} 
     * @param dates {module:model/OrderDeliveryDatesDTO} 
     * @param deliveryServiceId {Number} Идентификатор службы доставки.
     */
    constructor(type, serviceName, deliveryPartnerType, dates, deliveryServiceId) { 
        
        OrderDeliveryDTO.initialize(this, type, serviceName, deliveryPartnerType, dates, deliveryServiceId);
    }
     ...
     */
    static initialize(obj, type, serviceName, deliveryPartnerType, dates, deliveryServiceId) { 
        obj['type'] = type;
        obj['serviceName'] = serviceName;
        obj['deliveryPartnerType'] = deliveryPartnerType;
        obj['dates'] = dates;
    ...
    static validateJSON(data) {
        ...
        for (const property of OrderDeliveryDTO.RequiredProperties) {
...
OrderDeliveryDTO.RequiredProperties = ["type", "serviceName", "deliveryPartnerType", "dates", "deliveryServiceId"];
