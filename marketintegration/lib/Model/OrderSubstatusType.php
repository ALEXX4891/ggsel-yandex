...
class OrderSubstatusType
{
    ...
    public const DELIVERY_DATE_CHANGED_TOO_MUCH = 'DELIVERY_DATE_CHANGED_TOO_MUCH';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::DELIVERY_DATE_CHANGED_TOO_MUCH,
            self::UNKNOWN
        ];
    }
}
