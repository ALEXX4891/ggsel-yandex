...
class SkuBidRecommendationItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\PriceRecommendationItemDTO[]|null $price_recommendations {% note warning \"Этот параметр устарел\" %}  Не используйте его.  {% endnote %}  Рекомендованные цены.
     *
     * @return self
     * @deprecated
     */
