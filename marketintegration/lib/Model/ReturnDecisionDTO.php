...
class ReturnDecisionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets refund_amount
     *
     * @param int|null $refund_amount {% note warning \"Этот параметр устарел\" %}  Вместо него используйте `amount`.  {% endnote %}  Сумма возврата в копейках.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param int|null $partner_compensation {% note warning \"Этот параметр устарел\" %}  Вместо него используйте `partnerCompensationAmount`.  {% endnote %}  Компенсация за обратную доставку в копейках.
     *
     * @return self
     * @deprecated
     */
