...
class OrdersStatsOrderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\OrdersStatsPaymentDTO[] $payments Информация о денежных переводах по заказу.  Может вернуться пустым, если нет данных о переводах.
     *
     * @return self
     */
