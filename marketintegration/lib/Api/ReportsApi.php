...
class ReportsApi
{
     ...
     * @param  \OpenAPI\Client\Model\ReportFormatType|null $format Формат отчета. (optional)
     ...
     * @param  \OpenAPI\Client\Model\ReportFormatType|null $format Формат отчета. (optional)
     * @param  \OpenAPI\Client\Model\ReportLanguageType|null $language Язык отчета. (optional)
